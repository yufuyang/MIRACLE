...
public class CompanyMerchantUserController {
    ...
    public Result<Page<MerchantUser>> page(
        ...
        return Result.ok(merchantUserService.pageMerchantUser(merchantId, current, size));
    }
